...
- Optionally, a FOSSIL driver such as [X00](https://defsol.com/files/fossil/x00v124.zip) — required by most classic DOS doors
...
Most classic DOS doors use the [FOSSIL](https://en.wikipedia.org/wiki/FOSSIL) serial interface for COM1 I/O. If your door fails to start or falls back to local mode, a FOSSIL driver is needed. [X00](https://defsol.com/files/fossil/x00v124.zip) works well with v86.
