---
title: Z-Machine Interactive Fiction
...
* [Local Doors](index.md) — overview of all local door approaches
* [Native v86 Emulation](v86.md) — for DOS-based door games
* [Scripts & Native Binaries](scripts-and-binaries.md) — for terminal apps / shell scripts
