...
description: "How ENiGMA½ imports and exports to external message networks, and which are supported."
sidebar:
    order: 2
---
...
:::note
A related section under `scannerTossers.<name>` may provide configuration for scanning (importing) and tossing (exporting) messages for a particular network type. As an example, FidoNet-Style networks often work with BinkleyTerm Style Outbound (BSO) and thus the [FTN/BSO scanner/tosser](bso-import-export.md) (`ftn_bso`) module.
:::
