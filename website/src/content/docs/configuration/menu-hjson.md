...
#### System Methods
Many built in global/system methods exist. Below are a few. See [system_menu_method](https://github.com/NuSkooler/enigma-bbs/blob/master/core/system_menu_method.js) for more information.
