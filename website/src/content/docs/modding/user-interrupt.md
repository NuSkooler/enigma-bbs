...
sidebar:
    order: 3
---
ENiGMA½ provides functionality to "interrupt" a user for various purposes such as a [node-to-node message](../modules/node-msg.md). User interruptions can be queued and displayed at the next opportune time such as when switching to a new menu, or realtime if appropriate.
...
## See Also
See [user_interrupt_queue.js](https://github.com/NuSkooler/enigma-bbs/blob/master/core/user_interrupt_queue.js) as well as usage within [menu_module.js](https://github.com/NuSkooler/enigma-bbs/blob/master/core/menu_module.js).
