        ...
        async.series(
            [
                ...
                callback => {
                    ...
                    const id = `Created with ENiGMA 1/2 BBS v${enigmaVersion} Copyright (c) 2015-2026 Bryan Ashby`;
    ...
    _encodeWithFallback(s, encoding) {
        try {
            ...
            this.emit(
                'warning',
                Errors.General(
                    `Failed to encode buffer using ${encoding}: ${e.message}; Falling back to 'ascii'`
                )
            );
