...
describe('config schema against config_default.js', () => {
    ...
    it('still finds every meta path the defaults are supposed to declare', () => {
        ...
        const DECLARED_IN_DEFAULTS = [
            ...
            'chatServers.mrc.serverPort',
            'chatServers.mrc.serverSslPort',
            'contentServers.gopher.port',
            'contentServers.gopher.publicHostname',
            'contentServers.gopher.publicPort',
            'contentServers.nntp.nntp.port',
            'contentServers.nntp.nntps.port',
            'contentServers.nntp.publicMessageConferences',
            'contentServers.web.domain',
            'contentServers.web.handlers',
            'contentServers.web.http.port',
            'contentServers.web.https.port',
            'contentServers.web.logging.rotatingFile.level',
            'email.inbound.imap.maxMessagesPerRun',
            'email.inbound.imap.pollIntervalMs',
            'email.inbound.imap.port',
